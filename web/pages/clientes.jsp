...
<html lang="en">
    ...
    <head>
        ...
        <title>Clientes | Sucursal Electrónica</title>
                                ...
                                <div class="card">
                                    <div class="nav-header">
                                        ...
                                        <div style="text-align:right;width: 50%;">
                                            <a href="edit-clientes.jsp"><button class="btn add-new btn-primary mt-100" type="button"><span>Gestionar</span></button></a>
