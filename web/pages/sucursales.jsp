...
<html lang="es">
    ...
    <head>
        ...
        <title>Sucursales | Sucursal Electrónica</title>
                                ...
                                <div class="card">
                                    <div class="nav-header">
                                        ...
                                        <div style="text-align:right;width: 50%;">
                                            <a href="sucursales-edit.jsp"><button class="btn add-new btn-primary mt-100" type="button"><span>Agregar nueva sucursal</span></button></a>
                                ...
                                <div class="card">
                                    <div class="nav-header">
                                        ...
                                        <div>
                                            ...
                                            %>
                                            <br>
                                            <% Dba dbmapa = new Dba(application.getRealPath("usuarios-sucursal.mdb"));
                                                dbmapa.conectar();
                                                dbmapa.query.execute("SELECT a.numero_mesa, a.centro_de_votacion, a.status_mesa, b.nombre_departamento, c.nombre_municipio, a.nombre_sector_domicilio, a.latitud, a.longitud, a.id_mesa "
                                                        ...
                                                        + "LIKE '" + request.getParameter("id_sucursal") + "' "
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="">
                                                        <ul class="list-group list-group-flush">
                                                            <li class="list-group-item">ID DE SUCURSAL <strong> <%=numero_mesa%> </strong></li>
                                                            <li class="list-group-item">NOMBRE SUCURSAL <strong> <%=centro_v%></strong></li>
                                                            <li class="list-group-item">DEPARTAMENTO Y MUNICIPIO DE DOMICILIO: <strong><%=municipio%>, <%=departamento%></strong></li>
                                                            <li class="list-group-item">DIRECCIÓN:: <strong><%=colonia%></strong></li>
                                                            <li class="list-group-item">HORARIO: <strong><%=estatus%></strong></li>
                                                            <li class="list-group-item">VER RUTA EN GOOGLE MAPS: <strong><a href="https://www.google.es/maps?q=<%=latitud%>,<%=longitud%>" >AQUÍ</a></strong></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </section>
                                    ...
                                    <div class="card-datatable table-responsive pt-0" style='padding: 1rem !important;'>
                                        ...
                                        <table class="user-list-table "  id="datatable">
                                            <thead class="thead-light">
                                                <tr class = "thead-dark">
                                                    <th data-field="nombre" data-editable="false">ID SUCURSAL</th>
                                                    <th data-field="operaciones" data-editable="false">NOMBRE SUCURSAL</th>
                                            ...
                                            <tbody>
                                                <% Dba db = new Dba(application.getRealPath("usuarios-sucursal.mdb"));
                                                    ...
                                                    String id_sucursal, codigo_mesa, centro_de_votacion, nombre_departamento, nombre_municipio, nombre_sector_domicilio, latitud, longitud, estatus, estado_mesa;
                                                    Boolean estado;
                                                    while (rs.next()) {

                                                        id_sucursal = rs.getString(1);
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-left align-items-center">
                                                            <i class="fas fa-external-link-square-alt"></i><a href="sucursales.jsp?id_sucursal=<%=id_sucursal%>&latitud=<%=latitud%>&longitud=<%=longitud%>&p_centro=<%=centro_de_votacion%>&zoom_m=17&ver_mapa=1" onclick="mostrar_mapa(1)">Ver información</a>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td> 
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a class="dropdown-item"  data-toggle="modal" data-target="#inlineForm" onclick="mod('<%=id_sucursal%>', '<%=estado%>')">
                                                                    <i data-feather="edit-2" class="mr-50"></i>
                                                                    <span>Modificar</span>
                                                                </a>
                                                                <a class="dropdown-item" href="sucursales.jsp?p_id=<%=id_sucursal%>&p_eliminar=1">
            ...
            <div d="myModal" class="modal-dialog modal-dialog-centered" role="document" i>
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel33">Modificar Sucursal</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form name="fM1" action="sucursales.jsp" method="POST">
                        <input type="hidden" id="idh1" name="ti_id" value="" />
                        <div class="modal-body">
                            <label>Abierto o Cerrado </label>
