                                        ...
                                        <div class="card">
                                            ...
                                            <div class="nav-header">
                                                <div style="text-align:left;width: 100%;">
                                                    <form name="f1" action="edit-clientes.jsp" method="POST">
                                                        <h3>Agregar Cliente</h3>
                                                        <div class="modal-body flex-grow-1">
                                                            <div class="form-group">
                                                                <label class="form-label" for="name-presidente">Nombre del Cliente</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="form-label" for="enlace-url">Fotografía</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="form-label" for="enlace-url">Número de Tarjeta</label>
                                                                <input type="number" name="nombre_movimiento"  id="basic-icon-default-uname" class="form-control dt-uname" placeholder="0000-0000-0000-0000" >
                                                            </div>  
                                                ...
                                                <table class="user-list-table ">
                                                    <thead class="thead-light">
                                                        <tr>
                                                            ...
                                                            <th data-field="descripcion" data-editable="false">NOMBRE CLIENTE</th>
                                                            <th data-field="operaciones" data-editable="false">TARJETA</th>
                                                            <th data-field="operaciones" data-editable="false">No. Tarjeta</th>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <% Dba db = new Dba(application.getRealPath("usuarios-sucursal.mdb"));
                                                            ...
                                                            String id_presidente, nombre, photo, url_logo, genero, partido_politico, src_url_logo, tarjeta;
                                                            while (rs.next()) {
...
<!--                                                            <td>
                                                            ...
                                                            <td>
                                                                <div class="img-logo-gestionar-partido">
                                                                    <img src="<%=photo%>" alt="<%=photo%>" style="width: 30% !important;">
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="d-flex justify-content-left align-items-center">
                                                            ...
                                                            <td> 
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        <a class="dropdown-item" href="edit-clientes.jsp?p_id=<%=id_presidente%>&p_eliminar=1">
            ...
            <div d="myModal" class="modal-dialog modal-dialog-centered" role="document" i>
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="myModalLabel33">Modificar Cliente</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form name="fM1" action="edit-clientes.jsp" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <label>URL Foto de CLiente: </label>
                            <div class="form-group">
                        ...
                        <div class="modal-footer">
                            <input type="submit" value="Modificar Cliente" name="bt_modificar" /><br>    
