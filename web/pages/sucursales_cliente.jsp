                                        ...
                                        <table class="user-list-table "  id="datatable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-left align-items-center">
                                                            <i class="fas fa-external-link-square-alt"></i><a href="sucursales_cliente.jsp?id_sucursal=<%=id_sucursal%>&latitud=<%=latitud%>&longitud=<%=longitud%>&p_centro=<%=centro_de_votacion%>&zoom_m=17&ver_mapa=1" onclick="mostrar_mapa(1)">Ver información</a>
                                                        </div>
                                                    </td>
                                                    <td>
