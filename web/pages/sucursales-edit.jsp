                                    ...
                                    <div class="nav-header">
                                        <div style="width: 100%;">
                                            <div style="display: flex;justify-content: space-between;margin:5px 0 15px 0">
                                                <a href="sucursales.jsp"><i class="fas fa-arrow-left"></i>Regresar</a>
                                        ...
                                        <div class="card">
                                            <div class="nav-header">
                                                <div style="text-align:left;width: 100%;">
                                                    <form name="f1" action="sucursales-edit.jsp" method="POST">
                                                        <h3>Agregar Sucursal</h3>
                                                        <div class="modal-body flex-grow-1">
                                                            <div class="form-group">
                                                                <label class="form-label" for="name-presidente">Número de Sucursal</label>
                                                                <input type="text" name="numero_mesa" class="form-control dt-full-name" id="basic-icon-default-fullname" placeholder="0000" >
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="form-label" for="name-presidente">Nomre Sucursal</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="form-label" for="enlace-url">DIRECCIÓN</label>
                                                            ...
                                                            <td> 
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        <a class="dropdown-item" href="sucursales-edit.jsp?p_id=<%=id_mesa%>&p_eliminar=1">
        ...
        <div class="modal fade text-left" id="inlineForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
            <div d="myModal" class="modal-dialog modal-dialog-centered" role="document" i>
                <div class="modal-content">
                    ...
                    <form name="fM1" action="sucursales-edit.jsp" method="POST">
                        ...
                        <div class="modal-footer">
                            <input type="submit" value="Modificar Sucursal" name="bt_modificar" /><br>    
