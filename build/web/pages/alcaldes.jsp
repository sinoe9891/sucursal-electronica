                                    ...
                                    <div class="responsive">
                                        <%
                                            try {
                                                ...
                                                db.conectar();
                                                db.query.execute("select nombre_alcalde, photo_profile, src_url_logo_movimiento, genero_presidente from alcaldes ORDER BY id_alcalde ASC");
